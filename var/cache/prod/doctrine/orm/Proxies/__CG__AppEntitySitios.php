 ...
 */
class Sitios extends \App\Entity\Sitios implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'animales' => [parent::class, 'animales', null],
        "\0".parent::class."\0".'id' => [parent::class, 'id', null],
        'Nombre' => [parent::class, 'Nombre', null],
        'animales' => [parent::class, 'animales', null],
